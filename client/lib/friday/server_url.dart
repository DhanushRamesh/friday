...
/// `--dart-define=FRIDAY_URL=http://192.168.0.105:8080`.
///
...
/// address is the dev server rather than FRIDAY, and for pointing a build
/// at something neither of the two defaults covers.
const String _override = String.fromEnvironment('FRIDAY_URL');
...
const String _development = String.fromEnvironment('FRIDAY_DEV_URL');

/// _deployed : Where FRIDAY answers from, and the only address a release
/// build will ever use.
...
///
/// In production the web bundle is served by FRIDAY itself, so the page's
