...
/// FSpinner : A small indeterminate spinner in the accent colour.
class FSpinner extends StatelessWidget {
  const FSpinner({super.key, this.size = 16, this.color});
...
/// FThinkingDots : Three dots that rise in turn, shown while FRIDAY is
...
class FThinkingDots extends StatefulWidget {
  const FThinkingDots({super.key, this.size = 5});

  final double size;

  @override
  State<FThinkingDots> createState() => _FThinkingDotsState();
}

class _FThinkingDotsState extends State<FThinkingDots>
