...
/// FComposer : Where a prompt is typed.
///
...
class FComposer extends StatefulWidget {
  const FComposer({
    super.key,
  ...
  @override
  State<FComposer> createState() => _FComposerState();
}

class _FComposerState extends State<FComposer> {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: FSpacing.md),
          Expanded(
            child: Text(
...
///
/// The one unmistakable sign that FRIDAY is hearing the room, which matters
